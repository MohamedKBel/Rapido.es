        ...
        <div class="row">
            <div class="col-12 col-md-6 offset-md-3">
                ...
                <form action="/login" method="POST" role="form" class="form-control"> 
                    ...
                    <!--Password -->
                    <div class=" space-around my-2"> <input type="password" name="password" id="password"
                ...
                <p class="my-3">¿Aún no eres de los nuestros? <a class="btn btn-info b tn-sm ms-2" href="{{ route('register')}}">¡Registrate!</a>
                </p>
            </div>
        </div>
    </div>
